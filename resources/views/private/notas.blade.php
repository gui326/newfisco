    ...
    <div class="modal fade" id="notaModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-body">
                ...
                <div class="mt-2 row">
                    <div class="col-xl-6">
                        <label class="labelMinus">Entrada</label>
                        <input type="text" class="form-control" id="entrada" readonly>
                    </div>
                    <div class="col-xl-6">
                        <label class="labelMinus">Saída</label>
        ...
        function verNota(id){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#data').val(data.data);
                    $('#entrada').val(entrada.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'}));
                    $('#saida').val(saida.toLocaleString('pt-br',{style: 'currency', currency: 'BRL'}));
