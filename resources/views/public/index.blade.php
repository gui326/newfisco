...
@section('conteudo')
    ...
    <section>
        <div class="container-fluid pt-5 pb-5" style="padding: 0 7%;">
            <div class="row">
                <div class="col-xl-6">
                    <p style="color: #444!important; font-size: 50px; font-weight: 800" class="mt-1"><span class="colorPatternPrimary">New</span>Fisco</p>
                    <p style="line-height: 30px; color: #444!important; font-size: 25px;font-weight: 600;width: 70%;">Uma nova solução tecnológica, para fazer o seu sistema contábil decolar.</p>
    ...
    <section style="color: white; background: linear-gradient(180deg, rgba(202, 64, 139, 0.79) 0%, #CA408B 54.17%);">
    <div class="container-fluid" style="padding: 2% 7%;">
        <div class="mt-5 mb-5 row">
        <div class="mt-5 mb-5 col-xl-4 text-center">
